...
import jcifsng212.ntlmssp.av.AvFlags;
import jcifsng212.ntlmssp.av.AvPair;
import jcifsng212.ntlmssp.av.AvPairs;
import jcifsng212.ntlmssp.av.AvSingleHost;
import jcifsng212.ntlmssp.av.AvTargetName;
import jcifsng212.ntlmssp.av.AvTimestamp;
import jcifsng212.smb.NtlmUtil;
...
public class Type3Message extends NtlmMessage {
    ...
    public String toString () {
        ...
        return "Type3Message[domain=" + domainString + ",user=" + userString + ",workstation=" + workstationString + ",lmResponse="
                ...
                + jcifsng212.util.Hexdump.toHexString(getFlags(), 8) + "]";
    }
